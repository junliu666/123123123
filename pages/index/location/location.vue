<template xlang="wxml">
	<view class="container">
		<view class="qrimg">
			<tki-qrcode v-if="ifShow" :src="src" ref="qrcode" :val="val" :size="size" :unit="unit" :background="background" :foreground="foreground" :pdground="pdground" :icon="icon" :iconSize="iconsize" :lv="lv" :onval="onval" :loadMake="loadMake" :usingComponents="true" @result="qrR" />
		</view>
...
export default {
	data() {
		return {
			ifShow: true,
			val: 'https://github.com/q310550690/uni-app-qrcode', // 要生成的二维码值
			size: 200, // 二维码大小
			unit: '1upx', // 单位
	...
	methods: {
		...
		qrR(res) {
			console.log("https://github.com/q310550690/uni-app-qrcode");
		},
		clearQrcode() {
